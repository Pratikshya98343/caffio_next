...
import { Heart, Star, Plus, Minus, ShoppingCart, Check, Coffee, Clock } from 'lucide-react';
...
export default function CaffioAddToCart() {
  ...
  const product = {
    ...
    rating: 4.9,
    reviews: 342,
    description: "Our exclusive signature latte crafted with premium Colombian arabica beans, perfectly steamed milk, and our secret blend of vanilla and caramel notes. A smooth, rich experience that defines the Caffio brand.",
  ...
  const sizes = [
    { name: 'Small', price: -0.50, size: '8oz', ml: '240ml' },
  ...
  const getCurrentPrice = () => {
    ...
    const milkUpcharge = milkOptions.find(m => m.name === selectedMilk)?.price || 0;
    const shotUpcharge = extraShots * 0.75;
    return (product.basePrice + sizeUpcharge + milkUpcharge + shotUpcharge) * quantity;
  };
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <span className="text-amber-600 font-semibold">• {product.origin}</span>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-xl text-gray-500 line-through">${(product.originalPrice * quantity).toFixed(2)}</span>
                </div>
                <div className="text-right">
                  <div className="text-sm text-gray-600">You save</div>
                  <div className="text-lg font-bold text-green-600">
                    ${((product.originalPrice - getCurrentPrice() / quantity) * quantity).toFixed(2)}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Temperature</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                {sizes.map((size) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-600">{size.size} • {size.ml}</div>
                    <div className="text-sm font-semibold">
                      {size.price > 0 ? `+$${size.price.toFixed(2)}` : size.price < 0 ? `-$${Math.abs(size.price).toFixed(2)}` : 'Standard'}
                    </div>
                  </button>
                ))}
              </div>
            ...
            {/* Milk Options */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Milk Options</h3>
            ...
            {/* Extra Shots */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Extra Shots ($0.75 each)</h3>
              <div className="flex items-center justify-between bg-white/80 backdrop-blur-sm rounded-xl p-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-xl font-bold min-w-[2rem] text-center">{extraShots}</span>
                  <button
            ...
            {/* Sweetness Level */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Sweetness Level</h3>
            ...
            <button
              ...
              className={`w-full py-5 px-8 rounded-2xl font-bold text-xl transition-all duration-300 ${
                isAddedToCart
                  ...
                  : 'bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 hover:from-amber-600 hover:via-orange-600 hover:to-red-600 text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-1'
              }`}
            >
              <div className="flex items-center justify-center space-x-3">
                {isAddedToCart ? (
                  ...
                  <>
                    ...
                    <span>Add to Cart • ${getCurrentPrice().toFixed(2)}</span>
                  </>
                )}
              </div>
            </button>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3 text-gray-700">
                ...
                <div className="flex justify-between items-center">
                  <span>Size:</span>
                  <span className="font-semibold">{selectedSize} {sizes.find(s => s.name === selectedSize)?.size}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Milk:</span>
                ...
                <div className="border-t border-gray-200 pt-3">
                  <div className="flex justify-between items-center text-lg font-bold">
                    ...
                    <span className="text-2xl text-amber-600">${getCurrentPrice().toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
