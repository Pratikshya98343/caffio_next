...
const Menu = () => {
  ...
  const handleItemClick = (item) => {
    ...
    // In a real app, you would navigate to a new page with the item ID
    // Example: router.push(`/menu/${item.id}`)
    // For this demo, we'll show a modal-like detail view
  };
  ...
  if (selectedItem) {
    return (
      <section className="py-8 bg-gradient-to-br from-[#f8f5f2] to-white min-h-screen">
        <div className="max-w-[1200px] mx-auto px-4">
          {/* Back Button */}
          <button 
            onClick={handleBackToMenu}
            className="flex items-center gap-2 text-[#8B4513] hover:text-[#A0522D] mb-8 font-semibold"
          >
            <FaArrowLeft size={20} />
            Back to Menu
          </button>
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <FaClock className="w-6 h-6 mx-auto mb-2 text-[#8B4513]" />
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <GiCoffeeCup className="w-6 h-6 mx-auto mb-2 text-[#8B4513]" />
                  ...
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <FaThermometerEmpty className="w-6 h-6 mx-auto mb-2 text-[#8B4513]" />
            ...
            >
              ...
              <div className="p-6 text-center">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => handleItemClick(item)}
                    className="px-4 py-2 border-2 border-[#8B4513] text-[#8B4513] rounded-full font-semibold text-sm hover:bg-[#8B4513] hover:text-white transition"
                  >
                    Details
                  </button>
                </div>
